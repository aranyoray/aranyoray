  ...
  window.AH_SCENARIO = {
    ...
    factions: [
      ...
      { id: 'CSA', name: 'Southern Rights / Confederacy', seat: 'Charleston · Richmond', color: '#5e5e5e', emoji: '⬜',
        tagline: 'Build a nation on cotton and slavery — and try to make the world need you.', locked: true,
        stats: { ECON: 55, ARMS: 40, POWER: 25 } },
      { id: 'KY', name: 'Kentucky', seat: 'Frankfort', color: '#5b7fa6', emoji: '🔷',
        tagline: 'The border state both sides needed and neither could take for granted.', locked: true,
        stats: { ECON: 50, ARMS: 35, POWER: 40 } },
      { id: 'FRM', name: 'The Freedom Movement', seat: 'Rochester · Port Royal', color: '#f2b134', emoji: '🟡',
        tagline: 'Black abolitionists, contrabands, USCT soldiers: the people freedom was about.', locked: true,
        stats: { ECON: 25, ARMS: 20, POWER: 20 } },
      { id: 'GBR', name: 'Britain', seat: 'London', color: '#8b1e3f', emoji: '🟥',
        tagline: 'The empire that abolished slavery, ran on Southern cotton, and could tip the war.', locked: true,
        stats: { ECON: 70, ARMS: 65, POWER: 65 } },
      { id: 'CHR', name: 'Cherokee Nation', seat: 'Tahlequah', color: '#b5563a', emoji: '🟤',
        tagline: 'A sovereign nation removed fifteen years earlier, with its own civil war coming.', locked: true,
